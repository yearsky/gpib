        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="{{url('gallery/'.$gallery->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Title</label>
                          <input type="text" name="title" class="nama form-control" id="exampleInputEmail1" value="{{$gallery->title}}" placeholder="Cth: GodBless">
...
@section('scripts')
        ...
        layoutTemplates: {
            ...
            initialPreview: ["<img src='{{$gallery->getImage()}}' class='file-preview-image' alt=''>",],
