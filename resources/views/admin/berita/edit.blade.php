        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="{{url('berita/'.$berita->id_berita)}}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Judul Berita</label>
                        <input type="text" name="judul" class="nama form-control" value="{{$berita->judul}}" id="exampleInputEmail1" placeholder="Cth: Tuhan itu baik">
                        </div>
                        <div class="form-group">
                        ...
                        <input type="text" name="author" value="{{$berita->author}}" class="nama form-control" id="exampleInputEmail1" placeholder="Cth: Admin">
                        </div>
                        <div class="form-group">
...
@section('scripts')
        ...
        layoutTemplates: {
            ...
            initialPreview: ["<img src='{{$berita->getImage()}}' class='file-preview-image' alt=''>",],
